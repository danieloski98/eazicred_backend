...
export const PaydayloanValidator = joi.object({
  ...
  current_employer_office_number: joi.any().optional(),
  staff_id: joi.any(),
  department: joi.string(),
  job_title: joi.string(),
  date_employed: joi.any().optional(),
  previous_employer: joi.any().optional(),
  previous_employer_address: joi.any().optional(),
  //length_of_time_with_previous_employer: joi.number(),
  jobs_in_past_5_years: joi.any().optional(),
